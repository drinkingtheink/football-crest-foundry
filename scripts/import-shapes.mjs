...
const SRC = [
  ...
  // Batch 4
  { id: 'sh2-lozenge', label: 'Lozenge', w: 186.3,  h: 124.53, d: 'M0,62.49c10.98-7.5,21.65-14.83,32.37-22.11C51.37,27.48,70.4,14.61,89.4,1.71c2.08-1.41,3.63-2.66,6.49-.7,29.53,20.23,59.19,40.25,88.8,60.34.41.28.75.64,1.6,1.36-9.65,6.58-19.05,12.99-28.46,19.39-19.69,13.37-39.49,26.59-59.01,40.21-4.41,3.08-7.27,2.85-11.62-.16C59.14,102.78,30.81,83.74,2.58,64.58c-.79-.54-1.49-1.2-2.58-2.09Z' },
  { id: 'sh2-capsule', label: 'Capsule', w: 79.92,  h: 129.73, d: 'M.21,64.36c0-9-.39-18.01.08-26.98C1.4,16.24,19.27-.26,40.29,0c21.32.27,38.95,17.31,39.37,38.61.34,17.49.35,35,0,52.49-.43,21.3-18.06,38.32-39.39,38.62C19.3,130.01,1.4,113.51.25,92.34c-.51-9.3-.09-18.65-.09-27.98.02,0,.03,0,.05,0Z' },
  { id: 'sh2-spade',   label: 'Spade',   w: 97.53,  h: 116.43, d: 'M95.69.34C64.28,20.34,32.99,20.38,1.12,0c0,0-12.65,71.82,47.25,116.43C81.88,93.56,104.28,37.76,95.69.34Z' },
  { id: 'sh2-scroll',  label: 'Scrolled',w: 92.76,  h: 119.23, d: 'M46.33,119.23c-7.99-8.65-18.12-12.39-28.5-15.62C3.55,99.16-2.01,90.61.64,75.7c1.39-7.83,4.39-15.37,5.79-23.19,1.55-8.63,3.06-17.46,2.81-26.15-.2-7.04-3.01-14.01-4.62-20.85,9.72,1.99,20.95,2.59,30.93-2.55,7.84-4.04,13.99-3.85,21.78.06,10.05,5.04,21.26,4.62,32.6,2.02-10.53,17.27-6.85,34.68-2.5,52.1,1.49,5.96,3.59,11.81,4.63,17.84,2.74,15.92-2.56,24.24-17.83,28.84-10.3,3.1-20.02,7.25-27.9,15.41Z' },
]
...
if (fresh.length === 0) {
  ...
  const out2 = src.replace(marker, `\n\n  // Shield / heraldic — user-supplied batch\n${block}\n\n  {\n    id: 'circular',`)
